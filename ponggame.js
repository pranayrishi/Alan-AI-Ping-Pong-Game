// try to initialize the goRight() and goLeft() functions at 39 and 37 key and learn how to connect from two different files
...
canvas.style = "position: absolute; top: 200px; left: 0px; right: 0px; bottom: 0px; margin: auto; border:2px solid blue";
...
function AIScore() {
    document.getElementById("demo").innerHTML = "AI Score: " + ai_score;
}
 
function UserScore() {
    document.getElementById("demo2").innerHTML = "User Score: " + user_score;
}
 
//from pong code:
Player.prototype.update = function (left) {
